# H1M_eval run — 2026-06-22_010703_H1M_eval
_2026-06-22T01:07:03Z_
...
## REAL candidate results — FULL gate (from --results)
- Medium-first: pass_rate 0.857 | neg-run 0.0857 | broke 1 (new 1) | neg-score 0 | avg ratio 3.476× | median 3.1×
- Medium: ratio 3.476× | est score 1.536 | neg-run 0.0857
- fragile new breaks: 1 | improved 5 | regressed 2

| gate check | verdict | detail |
|---|---|---|
| no_new_broken_baseline_vs_m7 | **REJECT** | 2 new break(s) |
| compression_improvement>=8% | **PASS** | +15.3% |
| medium_neg_run_not_up | **REJECT** | cand 8.6% vs m7 0.0% |
| medium_est_score_no_drop | **REJECT** | cand 1.536 vs m7 1.69 |
| no_pairing_or_missing_patch_errors | **REJECT** | 1 integrity error(s) |
- → **DECISION: REJECT** (rejected on: no_new_broken_baseline_vs_m7, medium_neg_run_not_up, medium_est_score_no_drop, no_pairing_or_missing_patch_errors)
