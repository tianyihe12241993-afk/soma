...
def append_coach(messages: list[Any]) -> list[Any]:
    return [*messages, {"role": "user", "content": [{"type": "text", "text": COACH_TEXT}]}]
...
def handle_assemble(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if mode == "passthrough":
        ...
        if not result_messages:
            ...
            pruned = False
        if mode == "tight":
            result_messages = append_coach(strip_coach(result_messages))
