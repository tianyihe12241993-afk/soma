"""SOMA comp-110 (CoT-Compression-5) — INTERIOR-CAP ladder — f1k-TIGHT (floor 1k, salience keeps capped at a 1.5k budget).
...
FLOOR = 1000
SALIENT_BUDGET = 1500  # tight variant: salient keeps capped (document order)
