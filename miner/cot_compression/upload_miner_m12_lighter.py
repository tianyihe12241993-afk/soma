#!/usr/bin/env python3
"""SOMA miner m12_lighter (EXP-1 depth variant: m12 with TARGET_TOKENS=16_000, all else identical). ORIG:
 m7_compliant — NEXT-ROUND RULE-COMPLIANT derivative of m7 (v11).
...
TARGET_TOKENS = 16_000          # tight-mode trajectory target
