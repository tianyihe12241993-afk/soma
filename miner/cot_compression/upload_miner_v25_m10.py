...
PERSIST_FAIL_THRESHOLD = 2     # v25: 3->2, catch flips one MORE round sooner (richer context BEFORE the
                               # wrong-fix commit that causes 250/255-style breaks). Safe now because v24's
                               # release-on-pass kicks a resolving-medium that trips this back to harvest.
...
def handle_assemble(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    persistent_failure = test_fail_rounds >= PERSIST_FAIL_THRESHOLD
