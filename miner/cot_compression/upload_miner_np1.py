...
NP_RESULT_CAP = 6_000          # near-passthrough: per-tool-result extractive cap (chars); stateless+deterministic+idempotent so the emitted prefix is byte-stable turn-to-turn (cacheable).
