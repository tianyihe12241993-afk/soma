"""SOMA comp-110 — CAPLADDER v2c (small-read fix: floor 700, head 1000, min-run 5; structure-preserving interior compression; fixes f1km's salience defect).
...
def compress_messages(
    ...
    if not isinstance(messages, list):
        return messages     # fail-open: return the original object untouched (never fabricate a list)
    try:
