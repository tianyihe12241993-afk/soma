"""SOMA comp-110 — CAPLADDER v2 (structure-preserving interior compression; fixes f1km's salience defect).
...
FLOOR = 2000        # interior tool results <= FLOOR chars pass through verbatim
HEAD_BUDGET = 2000  # verbatim head kept on big reads (whole lines)
TAIL_LINES = 3
MIN_RUN = 6         # only drop contiguous non-salient runs of at least this many lines
