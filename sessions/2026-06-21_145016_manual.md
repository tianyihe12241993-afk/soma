# Session checkpoint — 2026-06-21T14:50:15Z
**reason:** manual
**NOTE:** Board refresh (collect+reward) 14:48Z: 228 miners, 181 eligible. No movement — our scores identical (m7 E1.127/M1.421/H1.281), still win 0 elements; Medium gap +0.199 vs 5FbqgypX 1.620. Fixed cp1252 UnicodeEncodeError in compute_reward_elements.py (now writes UTF-8).

**git:** branch `main`, dirty
recent changes: ata/latest/category_winners.json, data/processed/leaderboard_snapshots.jsonl, reports/reward_projection.md, scripts/compute_reward_elements.py, data/raw/dashboard/2026-06-21/144822_leaderboard.json
