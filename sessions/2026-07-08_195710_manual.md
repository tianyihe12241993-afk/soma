# Session checkpoint — 2026-07-08T19:57:10Z
**reason:** manual
**NOTE:** capladder-v2 emulator: Gate A 10/10 (9th Gate-A-perfect arch) but Gate B -8.0pct weighted / -5.1pct raw. Offline predicted 20-51pct view-cut but LIVE = negative because ONE task (13964) flailed BOTH runs to 56-61 steps (-151/-135pct) - dragging the ratio-of-sums negative. Other tasks fine (15103 +34/27, 11551 +23/54, 13516 +38 on r2). SAME PATTERN as every prior arch: per-run flail lottery (13964 always the victim this batch) makes aggregate<<offline. cl2 est-score 1.027. This is the 9th architecture confirming: content cut is real (offline) but weighted aggregate is flail-dominated; no arch converts offline savings to reliable Gate B. Stop-rule: HOLD.
