# Session checkpoint — 2026-07-08T12:25:25Z
**reason:** manual
**NOTE:** EVIDENCE-WINDOW v1 emulator: Gate A PASS 10/10 (7th consecutive Gate-A-clean architecture) but Gate B -26.2pct weighted (offline predicted +22.4). Mechanism: INPUT 2-3x baseline everywhere (13964: 62-64k in, 52-54 steps, -171/-190pct) - deleting old evidence makes the agent RE-ACQUIRE it via fresh reads at weight 1.0. Re-read tax now proven across the ENTIRE design space: skeletons/menus, gentle floors, salience keeps, whole-message stubs - 7 architectures, ~100 graded runs, every content-removal strategy loses more at 1.0-weight re-acquisition than it saves at 0.1-weight cache. Loop-guard idealized clip (computed from f1km n=25) = ~15.6pct, still sub-20. Design space empirically closed at every visible door.
