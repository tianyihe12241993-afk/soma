# Session checkpoint — 2026-07-08T21:02:13Z
**reason:** manual
**NOTE:** E=-4 decode step 1: swebench rows all POSITIVE for all 3 miners - E=-4 is NOT swebench; strong hypothesis E=EXPLORE screening category (parser only extracts first array; qualifier pages have 5x3-type rows). Leader beats us on 15375 +49 vs -65.5 with HIGHER in% (8.5 vs 3.9) = compresses everywhere incl small reads; our floor-1200 passthrough is the 15375 drag. v2c = lower floor + explore-safe; parser extension next.
