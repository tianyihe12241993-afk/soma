# Session checkpoint — 2026-07-08T19:45:38Z
**reason:** manual
**NOTE:** 5 qualifiers now (was 2). Raw-savings band 24.2-44.9pct, all pass_with 5/5, in-frac 2.9-5.5pct. New #1 5EPDbSXL=44.9pct raw ALL-POSITIVE (E1.22/M1.10/H1.31 tot1.211). 5EkKL1jD qualified with E-4.00 (Easy sacrifice OK if M/H+savings carry). THRESHOLD pinned: aggregate raw >=~24-25pct + 5/5 correctness = qualify. capladder-v2 (offline 20-51pct view-read cut) is the right shape; emulator running (byo8f542p) will confirm live.
