# Session checkpoint — 2026-07-08T13:12:10Z
**reason:** manual
**NOTE:** DEEPSEEK-PARITY VERDICT (provider pinned+verified 3/3 probes): f1km -3.1pct wt (was 6.0 mixed-routing), evw -27.6 (was -26.2) - PROVIDER WAS NOT THE STORY; re-read/verification tax dominates under any routing. Agent fully profiled: NO client compaction (33 shrinks = sub-agent threads), slow runs = test-and-fix loops (bash+18/tests+9 per run, not re-reads), step lottery = first-fix-correctness stochasticity - no compliant lever. 4 more dead runs at 8-lane wave (threshold is ~6). CAMPAIGN EVIDENCE COMPLETE: 8 architectures ~130 graded runs, Gate A always perfect, Gate B never >17 honest. FINAL: hold comp-110 offense, comp-111 prep, watch eval-period announcements.
