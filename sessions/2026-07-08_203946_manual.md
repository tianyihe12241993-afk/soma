# Session checkpoint — 2026-07-08T20:39:46Z
**reason:** manual
**NOTE:** TIER-2 CROWN SMOKES (v2b): EDIT=RESOLVED. EXPLORE quality PROTECTED-OR-BETTER (11551: miner 0.33 = baseline; 15103: miner hit 5/5 core files PERFECT 1.0 vs baseline 0.8 - path-preserving salience WORKS on the crown metric). Explore token savings ~0/slightly-negative on these short single draws (few big interior reads -> tau~0; better than passthrough-0 only when savings>0). Scorer fix: real regions at patch-eval/workspace-snapshot/explore-result.json (not the trajectory regex). v2b crown profile: STRONG swebench, GOOD edit, quality-positive/tau-neutral explore. n=1/cell - directional only.
