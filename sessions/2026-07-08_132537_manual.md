# Session checkpoint — 2026-07-08T13:25:37Z
**reason:** manual
**NOTE:** CORRECTION: the 11.2pct-raw 'qualifier-2 footprint' was MIS-ATTRIBUTED - only detail file today is m1/5CDLSZ (its screener rows now visible: 11.2 raw, 2/5 neg). Qualifier-2 5GxLcC detail scrape did NOT save - RE-SCRAPE with explicit output check before trusting. STILL TRUE from leaderboard: 5GxLcC qualified with E-1.86/M-0.95 (heavy breaks CAN qualify). Codex f1km audit running (codex_f1km_audit.txt). Next session: re-scrape 5GxLcC detail, finish footprint comparison honestly, assemble f1km readiness report with Codex verdict.
