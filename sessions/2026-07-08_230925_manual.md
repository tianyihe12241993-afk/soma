# Session checkpoint — 2026-07-08T23:09:25Z
**reason:** manual
**NOTE:** SCORING REFRAME: board score = raw-savings-driven (1+0.5trim(ln), to 86pct), cache IRRELEVANT to score (only gate). We optimized wrong axis. Levers: more raw savings (28->45+) + zero breaks. New lever unlocked: POSITION-DEPENDENT aggression (recent full, old crushed) - free now that cache doesnt score. Building maxraw_v1. Test at n>=5 (n=2 mis-ranked variants).

**git:** branch `ops-snapshot`, dirty
recent changes: tate/DISCOVERIES.md, data/raw/dashboard/2026-07-08/230550_leaderboard.json, scratchpad/
