# Session checkpoint — 2026-07-08T23:11:38Z
**reason:** manual
**NOTE:** maxraw_v1 BUILT + n=5 emulator RUNNING (bekslx9g6, 25 solves). Position-dependent: recent 4 tool reads LIGHT (floor 1200), older interior CRUSHED (floor 350/head 300, structure-only). Compliance PASS, Tier-0 PASS (old-read 1059 vs recent 1743 - position-dependence confirmed, deterministic, tiling exact). Offline raw 13.9pct vs v2b 8.1pct (fixed-traj; live compounds higher). Scored at n=5 to match platform 5-run averaging (fixes n=2 flail mis-ranking). Levers: raw savings + zero breaks; cache abandoned (score-irrelevant).

**git:** branch `ops-snapshot`, dirty
recent changes: essions/index.jsonl, state/DISCOVERIES.md, state/latest.md, data/raw/dashboard/2026-07-08/230550_leaderboard.json, data/raw/readme_prompting/2026-07-08_231116_README_prompting.md, miner/cot_compression/upload_miner_maxraw_v1.py, scratchpad/, sessions/2026-07-08_230925_manual.md
