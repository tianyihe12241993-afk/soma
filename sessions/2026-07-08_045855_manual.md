# Session checkpoint — 2026-07-08T04:58:55Z
**reason:** manual
**NOTE:** Doctrine PINNED to CURRENT.md top + DECISIONS.md: screener two-gate requirements + crown priorities (qualify, review-survival, no-breaks, 3 types, generalize, trajectory) + retired-approaches list.
