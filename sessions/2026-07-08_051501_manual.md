# Session checkpoint — 2026-07-08T05:15:01Z
**reason:** manual
**NOTE:** Crown-alignment fix (user caught it): one-upload-per-hotkey means the screener candidate IS the eval candidate - winner must also validate on explore (tau needs savings, hit-noise quality) + edit locally before upload. Phase-2 plan + PINNED doctrine updated.
