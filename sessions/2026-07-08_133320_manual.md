# Session checkpoint — 2026-07-08T13:33:20Z
**reason:** manual
**NOTE:** Dashboard detail page changed to client-side shell (no flight data; RSC fetch empty; platform API 403 externally). Leaderboard OK. Fix plan recorded in NEXT_ACTIONS: port collect_runs.py action-discovery to collect_miner_detail.py. Codex f1km NO-GO reconciliation also pending.
