# Session checkpoint — 2026-07-08T13:48:20Z
**reason:** manual
**NOTE:** QUALIFIER FOOTPRINTS DECODED (collector fixed, RSC method): #1 5DtYjEJ=30.2pct raw, #2 5GxLcC=25.5pct raw - BOTH strong cache-stable (in-frac 3.0pct) non-breaking (5/5) compressors; savings on the 3 BIG tasks 30-45pct. The 11pct-qualify hypothesis DEAD (was our broken m1). Gate needs ~25-30pct raw; f1km 14-17 is short but target is now CONCRETE + proven reachable. Also: I'd used a wrong hotkey tail for #2 all session (fixed).
