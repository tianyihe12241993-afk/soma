# Session checkpoint — 2026-07-08T20:04:51Z
**reason:** manual
**NOTE:** Loop-guard NO-GO (no loops to collapse - flails were env-fighting + baseline artifact). CORRECTED cl2 vs pinned baselines: 13.3 weighted / 21.4 RAW, 10/10, estScore 1.188 = CAMPAIGN BEST, 2.8 raw pts below min qualifier (24.2). Baseline-epoch rule recorded. Knob change justified: v2b floor/head 1200, minrun 5 -> target ~25 raw. Next: offline + emulator.
