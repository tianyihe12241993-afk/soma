# Session checkpoint — 2026-06-22T03:41:45Z
**reason:** manual
**NOTE:** Pulled+merged MacBook/WSL research (8f0da13, 156 files) onto this Mac → HEAD 239b061; eval readiness confirmed (Docker up, Darwin); next = H1M smoke eval via run_real_eval.sh. setup/ bundle preserved.

**git:** branch `ops-snapshot`, dirty
recent changes: tate/CURRENT.md, sessions/2026-06-21_143208_manual.md
