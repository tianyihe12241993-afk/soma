# Session checkpoint — 2026-07-08T13:20:43Z
**reason:** manual
**NOTE:** BREAKTHROUGH: 2nd qualifier 5GxLcC (subm 08Jul 12:01) decoded: RAW savings only 11.2pct, per-task 22/-26/28/-23/12 (TWO NEGATIVE), all 5 pass_with=True, in-frac 2.7pct, E-1.86/M-0.95 - QUALIFIED ANYWAY. The 20pct WEIGHTED gate is passable from the 10-15pct raw zone when the in/out mix cooperates (weighted>>raw possible). OUR f1km/f1kt-class (14-17pct honest raw) IS IN THE QUALIFYING ZONE. Stop-rule calculus changed: an f1km-class shot is evidence-backed, not pure lottery. Next: Codex audit f1km + readiness; USER decides upload before 13 Jul 14:30 UTC.
