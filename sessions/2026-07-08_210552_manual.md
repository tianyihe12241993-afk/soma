# Session checkpoint — 2026-07-08T21:05:52Z
**reason:** manual
**NOTE:** E=-4 DECODED: screening board total = mean of 5 swebench task scores (exact for all 3 miners); E/M/H = difficulty buckets Easy={15375} M={13964,13516} H={15103,11551}; E=-4 = harsher attempt-level stat on 15375 (task mean 0.79 yet E floored; leader clean 1.22). ONE FIX = 15375 small-read compression (floor down). v2c: floor~700/head~1000. Parser extended (all arrays; screening = swebench-only rows).
